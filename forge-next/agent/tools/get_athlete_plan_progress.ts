...
export default defineTool({
  description:
    "Get progress on an athlete's active assigned plan. Without week/day: completion %, current position, skipped-day count, and assignment date. With week: day list and status for that week. With week and day: prescribed work, set status, and logged actuals for that day.",
